...
function toggleFormGroups() {
	...
	const groupBlank = document.getElementById('blank-group');
	...
	const checkboxBlank = document.getElementById('item_blank');
